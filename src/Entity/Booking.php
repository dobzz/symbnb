...
class Booking
{
     ...
     * @Assert\GreaterThan("today", message="La date d'arrivée doit être supérieur a la date d'aujourd'hui", groups={"front"})
     */
    private $startDate;
    ...
    public function isBookableDates(){
        // 1- Connaitre les dates qui sont impossibles pour l'annonce
        ...
        //tableau des chaines de caractères de mes journée
    ...
    /**
     * Permet de récupérer un tableau qdes journée qui correspondent à ma réservation 
     *
