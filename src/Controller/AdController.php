...
class AdController extends AbstractController
{
    ...
    {
        //$repo = $this->getDoctrine()->getRepository(Ad::class); //Méthode classique plutot que le paramètre
        $ads = $repo->findAll();
    ...
    public function show(Ad $ad){
        ...
        //$ad = $repo->findOneBySlug($slug); //Méthode classique plutot que le paramètre
